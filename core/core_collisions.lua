...
-- AABB objects (x,y,w,h)
function Collision.AABB(a,b)
  return Collision.CheckCollision(a.x,a.y,a.w,a.h, b.x,b.y,b.w,b.h)
end
--


-- AABB mouse (x,y) vs object(x,y,w,h)
function Collision.AABB_Mouse(mouse, object)
  return Collision.CheckCollision(mouse.x,mouse.y,1,1, object.x,object.y,object.w,object.h)
end
--
